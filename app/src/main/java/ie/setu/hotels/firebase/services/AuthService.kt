...
interface AuthService {
    ...
    suspend fun updateUserPhoto(uri: Uri) : FirebaseSignInResponse
    //suspend fun uploadHotelImage(uri: Uri) : FirebaseSignInResponse
    //suspend fun updateHotelImage(uri: Uri) : FirebaseSignInResponse
}
